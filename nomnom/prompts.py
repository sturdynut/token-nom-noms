...
- Each tick your energy drops by 1. At 0 you starve. Max energy {max_energy}.
...
TOKENS
- Every call to you costs tokens: all input (including this rules text) plus all output. The cost is deducted from your budget, which you always see.
...
- Every {report_every} ticks you must file a short report on your token strategy. That call is paid too.
...
def report_prompt(obs: dict, ledger, notes: str, tick: int) -> str:
